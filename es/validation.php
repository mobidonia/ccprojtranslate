...
return [
    ...
    'custom'               => [
        ...
        'address_id' => [
            'required' => 'Por favor seleccione su direccion',
        ],
        ...
        'general_payment_error_action'=>[
            'required'=>'El intento de pago falló. Si es administrador del sistema, verifique el problema en el proveedor de pagos.'
        ],
